document.addEventListener('DOMContentLoaded', function() {
    ...
    const allQuestions = [
    /*1*/   { q: 'বাংলাদেশের সকল পৌরসভার সদস্য সংখ্যা -', options: [ 'সমান', 'এলাকা ও জনসংখ্যার ভিত্তিতে নির্ধারিত', 'সরকার কর্তৃক নির্ধারিত', 'মেয়র কর্তৃক নির্ধারিত' ], answer: 1 }, 
        /*2*/   { q: 'বাংলাদেশের সর্ব উত্তরের জেলা থেকে হিমালয়ের কোন শৃঙ্গ দেখা যায়?', options: [ 'কাঞ্চনজঙ্ঘা', 'চিম্বুক', 'এভারেস্ট', 'কেওকারাডং' ], answer: 0 }, 
        /*3*/   { q: 'ঢাকায় সর্বপ্রথম কবে রাজধানী স্থাপিত হয়?', options: [ '১২১০ খ্রিষ্টাব্দে', '১৩১০ খ্রিষ্টাব্দে', '১৫২০ খ্রিষ্টাব্দে', '১৬১০ খ্রিষ্টাব্দে' ], answer: 3 },
        /*4*/    { q: 'ঢাকায় বাংলার প্রথম রাজধানী কবে স্থাপিত হয়?', options: [ '১৫১০ সালে', '১৫৯০ সালে', '১৬০০ সালে', '১৬১০ সালে' ], answer: 3 }, 
         /*5*/   { q: 'বাংলাদেশে সিটি কর্পোরেশনের সংখ্যা কয়টি?', options: [ '১২', '১৫', '৮', '৯' ], answer: 2 }, 
      /*6*/      { q: 'বাংলাদেশের বৃহত্তম জেলা কোনটি?', options: [ 'ঢাকা', 'নারায়ণগঞ্জ', 'রাঙামাটি', 'সিলেট' ], answer: 2 }, 
      /*7*/      { q: 'বাংলাদেশের প্রথম "সাইবার সিটি"', options: [ 'কুমিল্লা', 'ঢাকা', 'চট্টগ্রাম', 'সিলেট' ], answer: 3 }, 
       /*8*/     { q: 'Which of the following is the largest district In terms of volume?', options: [ 'Chattagram', 'Rangamati', 'Bandarban', 'Dhaka' ], answer: 1 },
        /*9*/    { q: 'Which one is the least populated division of Bangladesh?', options: [ 'Rangpur', 'Barisal', 'Mymensingh', 'Sylhet' ], answer: 1 },
        /*10*/    { q: 'Considering the land area, what is largest and smallest Upazila of Bangladesh?', options: [ 'Thanchi, Amtali', 'Shibaganj, Karnaphuli', 'Shyamnagar, Polash', 'Betagi, Bakergonj' ], answer: 2 }, 
,
{
    q: 'Most southern part district of Bangladesh is-',
    options: ['Panchagarh', 'Bandarban', 'Sylhet', 'Cox\'s Bazar'],   /*11*/ 
    answer: 3
  },
  {
    q: 'Which of the following district has two borderline countries?',  /*12*/ 
    options: ['Rangamati', 'Sylhet', 'Mymensingh', 'Lalmonirhat'],
    answer: 0
  },
  {
    q: 'In the history of Dhaka, when was it declared capital for the first time?',
    options: ['1601', '1610', '1621', '1630'],   /*13*/ 
    answer: 1
  },
{
    q: 'আয়তনে বাংলাদেশের সর্ববৃহৎ সিটি কর্পোরেশন কোনটি?',
    options: ['রাজশাহী', 'ঢাকা', 'চট্টগ্রাম', 'গাজীপুর'],  /*14*/ 
    answer: 3
  },
  {
    q: 'ঢাকাকে প্রথম কখন বাংলার রাজধানী করা হয়?',
    options: ['১৫১০ সালে', '১৫৯০ সালে', '১৬০০ সালে', '১৬১০ সালে'],  /*15*/ 
    answer: 3
  },
  {
    q: 'GMT বা গ্রিনিচমান সময়ের সাথে বাংলাদেশের সময়ের পার্থক্য কত ঘণ্টা?',
    options: ['৬ ঘন্টা', '৮ ঘন্টা', '১০ ঘন্টা', '৫ ঘন্টা'],  /*16*/ 
    answer: 0
  },
  {
    q: 'বাংলাদেশের সর্ব-উত্তরে অবস্থিত জেলার নাম?',
    options: ['কুড়িগ্রাম', 'পীরগঞ্জ', 'পঞ্চগড়', 'সিলেট'],  /*17*/ 
    answer: 2
  },
  {
    q: 'বাংলাদেশের সর্বশেষ বিভাগের নাম কী?',
    options: ['ময়মনসিংহ', 'বরিশাল', 'খুলনা', 'রংপুর'],  /*18*/ 
    answer: 0
  },
  {
    q: 'স্বাধীনতালগ্নে বাংলাদেশের জেলা ছিল কতটি?',
    options: ['১৯', '২১', '৩২', '48'],  /*19*/ 
    answer: 0
  },
  {
    q: 'আয়তনে বাংলাদেশের বড় জেলা কোনটি?',
    options: ['ঢাকা', 'নারায়ণগঞ্জ', 'পার্বত্য রাঙ্গামাটি', 'পার্বত্য বান্দরবান'],  /*20*/ 
    answer: 2
  },
  {
    q: 'ঢাকা কত সালে সুবা-বাংলার রাজধানী হয়?',
    options: ['১৬১০', '১৬১১', '১৯১২', '১৬১৫'],  /*21*/ 
    answer: 0
  },
  {
    q: 'In term of land area, which one is the largest district of Bangladesh?',
    options: ['Rangamati', 'Chittagong', 'Dhaka', 'Feni'],  /*22*/ 
    answer: 0
  },
{
    q: 'বাংলাদেশের বৃহত্তম উপজেলা কোনটি?',
    options: ['শ্যামনগর', 'ঘাটাইল', 'সাভার', 'বরকল'],  /*23*/ 
    answer: 0
  },
    {
    q: 'বংলাদেশের সবচেয়ে কম বসতিপূর্ণ জেলা কোনটি?',
    options: ['বান্দরবান', 'রাঙ্গামাটি', 'খাগড়াছড়ি', 'মেহেরপুর'],  /*24*/ 
    answer: 0
  },
   {
    q: 'তথ্য মন্ত্রণালয়ের বর্তমান নাম কী?',  /*25*/ 
  ...
  },
  {
    ...
    options: ['মালদ্বীপ', 'সন্দ্বীপ', 'হাতিয়া', 'বরিশাল'],  /*26*/ 
    answer: 3
  },
  {
    q: 'মুফল আমলে ঢাকার নাম কী ছিল?',
    options: ['ইসলামাবাদ', 'জাহাঙ্গীরনগর', 'বিক্রমপুর', 'সোনারগাঁও'],  /*27*/ 
    answer: 3
  },
  {
      q: 'বাংলাদেশে বর্তমানে বিভাগের সংখ্যা কয়টি?',
      options: ['৬টি', '৭টি', '৮টি', '৯টি'],  /*28*/ 
      answer: 2
    },
    {
      q: 'বাংলাবান্ধা কোন জেলায় অবস্থিত?',
      options: ['ঠাকুরগাঁও', 'শেরপুর', 'পঞ্চগড়', 'জয়পুরহাট'],  /*29*/ 
      answer: 2
    },
    {
      q: 'ঢাকা পৌরসভা\'র প্রথম নির্বাচন কবে অনুষ্ঠিত হয়?',
      options: ['১৬০৮ সালে', '১৮৬৪ সালে', '১৮৮৪ সালে', ' ১৯৯০ সালে'],  /*30*/ 
      answer: 2
    },
    {
        q: 'Of which place\'s former name "Gondowana land"?',
        options: ['Dinajpur', 'Bagerhat', 'Cox\'s-Bazar', 'Noakhali'],  /*31*/ 
        answer: 0
      },
      {
        q: 'What is the previous name of \'Barishal\'?',
        options: ['Chandradeep', 'Sudharam', 'Suvarna Gram', 'Bikrampur'],  /*32*/ 
        answer: 0
      },
      {
        q: 'What was the previous name of Comilla?',
        options: ['Tripura', 'Nasirabad', 'Sudharam', 'Subarnagram'],  /*33*/ 
        answer: 0
      },
      {
        q: 'বাংলাদেশের রুটির ঝুড়ি বলা হয় কোন জেলাকে?',
        options: ['বরিশাল', 'রাজশাহী', 'যশোর', 'দিনাজপুর'],  /*34*/ 
        answer: 3
      },
      {
        q: 'বাংলাদেশের সঙ্গে আন্তর্জাতিক সীমানা রয়েছে কয়টি দেশের?',  /*35*/ 
...

        {
          ...
          options: ['১টি', '২টি', '৩টি', '৪টি'],  /*36*/ 
          answer: 1
        },
        {
          q: 'বাংলাদেশের সঙ্গে আন্তর্জাতিক সীমানা রয়েছে কয়টি দেশের?',
          options: ['১টি', '২টি', '৩টি', '৪টি'],  /*37*/ 
          answer: 1
        },
        {
          q: 'বাংলাদেশের সাথে কোন দুটি দেশের স্থলসীমান্ত রয়েছে?',
          options: ['ভারত, পাকিস্তান', 'মালদ্বীপ, ভুটান', 'নেপাল, ভারত', 'ভারত, মায়ানমার'],  /*38*/ 
          answer: 3
        },
        {
          q: 'বাংলাদেশের ভৌগোলিক সঠিক অবস্থান কোনটি?',  /*39*/ 
        ...
        },
        {
            ...
            options: ['চাঁদপুর', 'ভোলা', 'বরিশাল', 'খুলনা'],  /*40*/ 
            answer: 2
          },
          {
            q: 'ঢাকার প্রাচীন নাম কি?',
            options: ['জাহাঙ্গীরনগর', 'ইসলামপুর', 'সোনারগাঁও', 'ঢাকা'],  /*41*/ 
            answer: 0
          },
          {
            q: 'বরিশাল এর পূর্বনাম কী?',
            options: ['হরিকেল', 'বরদ্বীপ', 'চন্দ্রদ্বীপ', 'সুবর্ণচর'],  /*42*/ 
            answer: 2
          },
          {
            q: '\'গন্ডোয়ানাল্যান্ড\'- কোন স্থানের পূর্বনাম?',
            options: ['দিনাজপুর', 'বাগেরহাট', 'কক্সবাজার', 'বান্দরবান'],  /*43*/ 
            answer: 0
          },
          {
            q: 'বর্তমান মুজিব নগরের পূর্বনাম কি?',
            options: ['চন্দ্রবাড়ি', 'ভবেরপাড়া', 'টুংগীপাড়া', 'শিমুলিয়া'],  /*44*/ 
            answer: 1
          },
          {
            q: 'বাংলাদেশে সীমান্তবর্তী ভারতের রাজ্যের সংখ্যা কয়টি?',  /*45*/ 
            options: ['৩টি', '৪টি', '৫টি', '৬টি'],
            answer: 2
          },
          {
            q: 'নিচের কোন রেখার উপর বাংলাদেশ অবস্থিত?',  /*46*/ 
            options: ['ট্রপিক অব ক্যাপ্রিকন', 'ট্রপিক অব ক্যানসার', 'ইকুয়েটর', 'আর্কটিক সার্কেল'],
            answer: 1
          },
          {
            q: 'বাংলাদেশের কোন জেলা আসামের অংশ ছিল?',
            options: ['সিলেট', 'চট্টগ্রাম', 'কুমিল্লা', 'দিনাজপুর'],  /*47*/ 
            answer: 0
          },
          {
            q: 'বাংলাদেশের কোন জেলায় কর্কটক্রান্তি রেখা ও ৯০ ডিগ্রি দ্রাঘিমাংশের ছেদ বিন্দু অবস্থিত?',
            options: ['নাটোর', 'ফরিদপুর', 'ঝালকাঠি', 'মাগুরা'],  /*48*/ 
            answer: 1
          },
            {
              q: 'বাংলাদেশ ও ভারতের মধ্যে সমুদ্র সীমানা নিয়ে বিরোধ মীমাংসা হয় কোন আদালতে?',
              options: ['International Court of Justice', 'International Tribunal for Law of the Sea', 'Permanent Court of Arbitration', 'International Criminal Court'],
              answer: 2
            },
            {
              q: 'বাংলাদেশের উত্তরে ভারতের কোন কোন রাজ্য অবস্থিত?',
              options: ['পশ্চিমবঙ্গ, আসাম ও মেঘালয়', 'আসাম ও মেঘালয়', 'আসাম, ত্রিপুরা ও মেঘালয়', 'ত্রিপুরা ও মিজোরাম'],
              answer: 0
            },
            {
              q: 'বাংলাদেশ ও মিয়ানমার সীমান্তে অবস্থিত নদী কোনটি?',
              options: ['সাঙ্গু', 'মাতামুহুরী', 'কর্ণফুলী', 'নাফ'],
              answer: 3
            },
            {
              q: 'বাংলাদেশের সমুদ্রসীমা বর্তমানে কত বর্গ কিলোমিটার?',
              options: ['৫০,০০০', '১৫,০০০', '২,৫০,০০০', '১,১৮,৮১৩'],
              answer: 3
            },
            {
              q: 'বাংলাদেশের কোন জেলার সাথে ভারত ও মিয়ানমার উভয় দেশের সীমান্ত রয়েছে?',
              options: ['ফেনী', 'কক্সবাজার', 'রাঙামাটি', 'বান্দরবান'],
              answer: 2
            },
            {
              q: 'নিচের কোনটি বাংলাদেশের টেরিটোরিয়াল সমুদ্র সীমার সঠিক পরিমাপ?',
              options: ['12NM', '20NM', '210NM', '250NM'],
              answer: 0
            },
            {
              q: 'বাংলাদেশ-ভারত ছিটমহল বিনিময় কার্যকর হয় কত সালে?',
              options: ['২০১৫', '২০১৪', '২০১৩', '২০১৬'],
              answer: 0
            },
            {
              q: 'কোন সমুদ্র সৈকতকে বাংলাদেশের "সাগরকন্যা" বলা হয়?',
              options: ['কক্সবাজার', 'পতেঙ্গা', 'কুয়াকাটা', 'সেন্টমার্টিন'],
              answer: 2
            },
            {
